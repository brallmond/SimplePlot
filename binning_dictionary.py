...
label_dictionary = {
  ...
  "CleanJetGT30_pt_1"  : r'Leading Jet $p_T$',
  "CleanJetGT30_eta_1" : r'Leading Jet $\eta$',
  "CleanJetGT30_phi_1" : r'Leading Jet $\phi$',
  "CleanJetGT30_pt_2"  : r'Sub-leading Jet $p_T$',
...
binning_dictionary = {
  ...
  "common" : {
    ...
    "CleanJetGT30_phi_1" : np.linspace(-3.2, 3.2, 16+1),
    "CleanJetGT30_phi_2" : np.linspace(-3.2, 3.2, 16+1),
    "CleanJetGT30_phi_3" : np.linspace(-3.2, 3.2, 16+1),
